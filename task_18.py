...
def findClosest(uniqueNumbers, size, m): # процедура поиска ближайшего числа методом бинарного поиска
    ...
    while (i < j):
        ...
        if (m < uniqueNumbers[mid]):
            ...
            # Если число больше предыдущего, то возвращаем ближайший из двух
        ...
        else: # Иначе, если число больше чем средний элемент массива
...
# Находим наиболее близкое значение, взяв разницу
# между m и обоими значениями. При этом предполагается.
# что val2 больше, чем val1, а n лежит между ними.
